...
class Tracker:
    ...
    def get_object_track(self,frames,read_from_stub=False,stub_path=None):
        ...
        if read_from_stub and stub_path is not None and os.path.exists(stub_path):
            ...
            return tracks
        # after doing the above step,we will save it(pickle) and wont need to run the below part again
        ...
        for frame_num,detection in enumerate(detections):
            ...
            # conerting to supervision format
...
# we will dray circles around instead of boxes
